...
import SecondIcons from "./SecondIcons.jsx";
function SocialIcons() {
  ...
  return (
    <>
      <button onClick={scrollToContact} className="lets-talk">
        Let's Talk
      ...
      <div id="SocailIcons">
        ...
        <div className="icons instaIcon">
          ...
          <a
            href="https://www.instagram.com/devkhamal_kano"
            target="_blank"
